...
class AMDataset(): 
    ...
    def data_loading_processing(self, num_points=100, shuffle=True, img_size=224, img_domain=200, scale_height=100, scale_time=10000, scale_temperature=100, freq_num = 32, query_dim=4): 
